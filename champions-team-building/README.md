...
(Regulation M-C, 2026-09-09 → 2026-12-02). This is the "memory" Claude reads at the start of a build,
...
- **roster.md** — the species list (seed; the live list is `app/dex-data.js`, 258 entries at Reg M-C).
